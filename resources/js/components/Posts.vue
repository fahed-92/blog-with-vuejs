    ...
    <div class="main-wrapper ">
                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-6 offset-md-0">
                        <div class="about-item ">
                            ...
                            <h2 class="mt-3 mb-4 position-relative content-title">We are dynamic team of creative
                                people</h2>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="cta-item  bg-white p-5 rounded">
                            ...
                            <p class="lead mb-4">Have any project on mind? For immediate support :</p>
                ...
                <div class="row testimonial-wrap">
                    <div class="testimonial-item position-relative">
                        ...
                        <div class="testimonial-item-content">
                            <p class="testimonial-text">Qualm maitres perspicacity temporise Podio cisgendered error alias
                                debits antique consequent natures gusto redundancy numeral corrupt facility
                                blandish.
                            </p>
                    ...
                    <div class="testimonial-item position-relative">
                        ...
                        <div class="testimonial-item-content">
                            <p class="testimonial-text">Consecrate radicalising elite. Qualm maitres perspiciatis
        ...
        <section class="section latest-blog bg-2">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 text-center" v-if="isSearching">
                        <div class="spinner-border text-danger text-center" role="status" style="width: 10rem; height: 10rem;">
                            <span class="sr-only">Loading...</span>
                        </div>
                    </div>
                    <div class="col-lg-8" v-else>
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 mb-5" v-for="post in posts.data" :key="post.id">
                                <div class="card bg-transparent border-0">
                                    <img :src="'assets/images/blog/' + post.image" alt="" class="img-fluid rounded">
                                    <div class="card-body mt-2 text-center">
                                        <div class="blog-item-meta">
                                            <a href="#" class="text-white-50">
                                                <i class="fa fa-adjust mr-2" v-if="post.category"></i>
                                                    Category :{{ post.category.name }}
                                            </a>
                                            <br>
                                            <a href="#" class="text-white-50"><i class="fa fa-comment mr-2"></i>Comments
                                                :{{ post.comments_counts }}
                                            </a>
                                            <br>
                                            <a href="#" class="text-white-50 ml-2"><i class="fa fa-user mr-2"
                                                                                      v-if="post.user"></i>Author
                                                :{{ post.user.name }}
                                            </a>
                                        </div>
    ...
    watch: {
        searchPost(query) {
            if (query.length > 0) {
                ...
                axios.get('/api/search-posts/' + query + '?page=1')
                    .then(res => {
                        this.posts = res.data
                    })
                    .catch(err => {
